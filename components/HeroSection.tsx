...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-brand-teal-deep">
      {/* Background Gradients & Cinematic Overlays */}
      <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_15%_60%,#0D4A47,transparent_55%),radial-gradient(ellipse_at_85%_20%,#1A7A72,transparent_50%)]" />
