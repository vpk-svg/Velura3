...
export const SEO_TREATMENTS: SeoTreatment[] = [
  ...
  { slug: 'wangen-fillers', category: 'fillers', titleKey: 'wangen_title', descKey: 'wangen_desc', heroImage: '/images/spares/high-angle-woman-getting-lip-fillers.jpg', priceFrom: '€450', features: ['wangen_f1', 'wangen_f2', 'wangen_f3'] },
  ...
  // Weightloss
  { slug: 'ozempic-afvallen', category: 'weightloss', titleKey: 'ozempic_title', descKey: 'ozempic_desc', heroImage: '/images/spares/female-fitness-model-holding-tape-measurer-around-her-waist-weightloss-concept.jpg', priceFrom: '€299/mnd', features: ['ozempic_f1', 'ozempic_f2', 'ozempic_f3'] },
  { slug: 'mounjaro-afvallen', category: 'weightloss', titleKey: 'mounjaro_title', descKey: 'mounjaro_desc', heroImage: '/images/spares/female-fitness-model-holding-tape-measurer-around-her-waist-weightloss-concept.jpg', priceFrom: '€425/mnd', features: ['mounjaro_f1', 'mounjaro_f2', 'mounjaro_f3'] },
  { slug: 'wegovy-afvallen', category: 'weightloss', titleKey: 'wegovy_title', descKey: 'wegovy_desc', heroImage: '/images/spares/female-fitness-model-holding-tape-measurer-around-her-waist-weightloss-concept.jpg', priceFrom: '€399/mnd', features: ['wegovy_f1', 'wegovy_f2', 'wegovy_f3'] },
